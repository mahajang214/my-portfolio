...
function App() {
  ...
  useGSAP(() => {
    ...
    const aboutME = new SplitText(".aboutHeading", {
      type: "words,chars",
    });

    const aboutPara = new SplitText(".aboutPara", {
      type: "words,chars",
    });

    const threeText = new SplitText(".sectionThreeText", {
      type: "words,chars",
    });
    ...
    media.add("(max-width: 480px)", () => {
      ...
      gsap.from(".ui-ux-services", {
        rotateX: 90,
        scrollTrigger: {
          trigger: ".ui-ux-services",
          start: "top 70%",
          end: "bottom 60%",
          markers: false,
          scrub: 0.5,
      ...
      gsap.set(
        [".frontend", ".backend", ".os", ".dev", ".hosting", ".cybertools"],
        {
          scale: 1,
          opacity: 1,
          y: 0,
...
gsap.from(project.chars, {
  ...
  return (
      ...
      <div className="w-full  mt-0 mb-0 p-2 overflow-hidden bg-black">
        ...
        >
          ...
          >
            <h1
              id="firstText"
              className="text-6xl md:text-[80px] lg:text-[120px] text-[#F4CE14]"
            >
              I'm
            </h1>
            <h1
          ...
          <div
            id="section"
            className="w-full absolute left-[100vw] top-0 h-screen   bg-black flex justify-center items-center text-white"
          >
            <div className="w-[80%] h-[80%]">
              ...
              <h2 className="aboutPara text-xl sm:text-2xl md:text-3xl mt-6 text-[#F5F7F8]">
                ...
                creativity with security because Security is never an
                afterthought in my work. I'm skilled in cybersecurity tools like
                Burp Suite, Wireshark, Nmap, Hydra etc. which I use to analyze
                vulnerabilities in my own websites and patch them before
                attackers can even try. That’s why the websites I build are not
                just stunning — They're designed with robust security measures
                to withstand potential attacks.
                <br />
                <br />
                ✨ what else I can do? <br />
                You should really check out my skills section.
              </h2>
            </div>
          </div>
          <div
	...
	129.088,260.512 123.456,206.88 332.512,204.416 336.736,147.008 117.856,147.616 114.176,94.208 256,94.208 397.824,94.208 "
          ...
          <div className="w-full py-5 bg-black  flex justify-center items-center ">
            {/* ANIMATED WEBSITE DEVELOPMENT  */}
            <div className="2xl:w-[80%] w-[90%]  py-5 lg:text-gray-800 text-gray-600">
              <h1 className="techText 2xl:text-[7vh] text-[3vh] sm:text-[3.5vh] md:text-[4vh] lg:text-[5vh] xl:text-[6vh]  text-center hover:text-[#F4CE14] transition-all duration-500 cursor-crosshair leading-7 lg:leading-[.5] sm:leading-[.8] font-bold my-5">
                ANIMATED WEBSITE DEVELOPMENT
              </h1>

              <h1 className="techText 2xl:text-[7vh] text-[3vh] sm:text-[3.5vh] md:text-[4vh] lg:text-[5vh] xl:text-[6vh]  text-center hover:text-[#F4CE14] transition-all duration-500 cursor-crosshair leading-7 lg:leading-[.5] sm:leading-[.8] font-bold my-5">
                WEB VULNARABILITIES TESTING
              </h1>
          ...
          <div className="w-full bg-black  py-5">
            <h1 className="aboutHeading project text-center text-4xl sm:text-[45px] md:text-[60px] lg:text-[90px]  text-[#F4CE14] font-normal">
              Projects
            </h1>
            <div className="w-full mt-5 lg:mt-12  py-2 flex  flex-col justify-center items-center ">
              ...
              >
                <div className="w-[60vw]  py-8 rounded-2xl">
                  <h1 className=" projectText text-center  text-4xl sm:text-[45px] md:text-[60px] lg:text-[90px]  text-[#379777] font-normal">
                    Full-Stack Realtime Chatting Website
                  </h1>
                  ...
                  {openChattinWeb && (
                    ...
                    >
                      <p className="text-gray-400  w-full px-[11.8%] text-xl ">
                      ...
                      <p className="text-gray-400  w-full px-[11.8%] mt-2 text-xl ">
                        <span className="text-gray-200  text-2xl">
                          Tech Used
                        </span>{" "}
                        <br />
                        Frontend: Html, Css, Tailwindcss, GSAP, scrollTrigger,
                        Reactjs, Zustand, Socket.io-client, React Router Dom,
                        Axios, javascript. <br />
              ...
              <div
                onMouseEnter={() => setOpenSocialMediaWeb(!openSocialMediaWeb)}
                onMouseLeave={() => setOpenSocialMediaWeb(!openSocialMediaWeb)}
                className="px-1 bg-[#ffffff23] rounded-2xl flex justify-center items-center flex-col  py-5 mt-5"
              >
                <div className="w-[60vw]   py-8 rounded-2xl">
                  <h1 className="projectText w-full text-center  text-4xl sm:text-[45px] md:text-[60px] lg:text-[90px]  text-[#379777] font-normal">
                  ...
                  {openSocialMediaWeb && (
                    ...
                    >
                      <p className="text-gray-400  w-full px-[11.8%] text-xl ">
                        ...
                        <br />
                        1.JWT authentication and authorization <br />
                        2.Profile management <br />
                        3.Post creation and interaction (like, comment, share){" "}
                        <br />
                        4.Real-time intractions <br />
                        5.Explore and search functionality <br />
                        6.1-on-1 Chat
                      </p>
                      <p className="text-gray-400  w-full px-[11.8%] mt-2 text-xl ">
                        <span className="text-gray-200  text-2xl">
                        ...
                        Router Dom, Axios, javascript. <br />
                        Backend: Nodejs, Expressjs, MongoDB, Mongoose,
            ...
            <div className="bg-[#379777] mt-[30vh] w-full rounded-t-[40px]">
              ...
              <div className="w-full flex justify-center items-center  rounded-2xl flex-col">
                <div className="w-[65vw] card py-5 bg-[#4ED7F1] px-4 -translate-y-[28vh] rounded-2xl">
                  ...
                  ></textarea>
                  <button className="w-full bg-[#379777] rounded-full mt-4 text-white font-bold text-xl cursor-pointer lg:text-4xl py-2 hover:rounded-md transition-all hover:scale-95 hover:duration-300">
                    Send
                  </button>
                  </form>
                ...
                <div className="w-[65vw] rounded-2xl -translate-y-[25vh] flex ">
                  ...
                  />
                  <button onClick={feedbackHandler} className="px-5  outline-none duration-200 hover:rounded-2xl rounded-r-xl bg-[#4ED7F1] text-white font-bold text-2xl cursor-pointer">
                    Send
                  </button>
